...
{
    /// <inheritdoc />
    public partial class AddUsersMocked : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 4, "Calle Central 9", "2B", "Córdoba", "Argentina", "andres@example.com", new DateTime(2025, 8, 24, 3, 16, 12, 932, DateTimeKind.Local).AddTicks(5081), "Andrés ", "admin123", "351222333", "Admin" });
